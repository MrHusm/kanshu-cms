LBF.define("lib.Zepto", function (require) {
    var t = function () {
        ...
        return G.matches = function (t, e) {
            ...
            var r, i, a;
            return Z.test(t) && (r = j(L.createElement(RegExp.$1))), r || (t.replace && (t = t.replace(k, "<$1></$2>")), e === E && (e = R.test(t) && RegExp.$1), e in I || (e = "*"), (a = I[e]).innerHTML = "" + t, r = j.each(D.call(a.childNodes), function () {
                a.removeChild(this)
            ...
            var r;
            if (!t)return G.Z();
            if ("string" == typeof t)if ("<" == (t = t.trim())[0] && R.test(t))r = G.fragment(t, RegExp.$1, n), t = null; else {
    ...
    return window.Zepto = t, window.$ === undefined && (window.$ = t), function (t) {
        function e(t) {
        ...
        function p(e) {
            e.processData && e.data && "string" != t.type(e.data) && (e.data = t.param(e.data, e.traditional)), !e.data || e.type && "GET" != e.type.toUpperCase() && "jsonp" != e.dataType || (e.url = h(e.url, e.data), e.data = undefined)
        }

        function d(e, n, r, i) {
            return t.isFunction(n) && (i = r, r = n, n = undefined), t.isFunction(r) || (i = r, r = undefined), {
                url: e,
                data: n,
                success: r,
                dataType: i
        ...
        S.href = window.location.href, t.active = 0, t.ajaxJSONP = function (e, n) {
            ...
            return n && n.promise(p), t(l).on("load error", function (o, u) {
                clearTimeout(i), t(l).off().remove(), "error" != o.type && r ? a(r[0], p, e, n) : s(null, u || "error", p, e, n), window[c] = f, r && t.isFunction(f) && f(r[0]), f = r = undefined
            ...
            r(u), u.crossDomain || ((n = y.createElement("a")).href = u.url, n.href = n.href, u.crossDomain = S.protocol + "//" + S.host != n.protocol + "//" + n.host), u.url || (u.url = window.location.toString()), (i = u.url.indexOf("#")) > -1 && (u.url = u.url.slice(0, i)), p(u);
...
LBF.define("monitor.SpeedReport", function (require) {
    var t = {url: "//isdspeed.qq.com/cgi-bin/r.cgi", rate: 1, calGap: !1}, n = {}, e = function (t) {
    ...
    return {
        create: function (t) {
            ...
            if (l && (n = l.timing)) {
                "undefined" != typeof n.msFirstPaint ? p.push("msFirstPaint") : s && (u = s), r = n[p[0]];
                for (var g = 1, h = p.length; g < h; g++)(o = (o = n[p[g]]) ? o - r : 0) > 0 && m.push(g + "=" + o);
                f && m.push("30=" + (f - r));
                var v = (v = t.url || "//isdspeed.qq.com/cgi-bin/r.cgi") + "?flag1=" + a + "&flag2=" + i + "&flag3=" + u + "&" + m.join("&");
                c && (v = c.replace("{url}", encodeURIComponent(v))), e(v)
            }
            ...
            if (p && (n = p.timing)) {
                "undefined" != typeof n.msFirstPaint ? m.push("msFirstPaint") : s && (g = s), r = n[m[0]];
                for (var h = 1, v = m.length; h < v; h++)(o = (o = n[m[h]]) ? o - r : 0) > 0 && u.push(h + "=" + o);
                f && u.push("30=" + (f - r));
                var E = t.url || l;
                E += "?flag1=" + a + "&flag2=" + i + "&flag3=" + g + "&" + u.join("&"), c && (E = c.replace("{url}", encodeURIComponent(E))), e(E)
            }
        }
    }
});
define("qdm/js/common/page/index.2b38d.js", ["lib.Zepto", "util.ejs2", "util.Cookie", "common.login.qidian", "qidian.report", "qidian.wxShare", "qdm/js/common/utils/debounce.5e0cc.js", "qdm/js/common/components/Toggle.b6163.js", "qdm/js/common/components/Tips.28ade.js", "qdm/js/common/components/Loading.f83d8.js", "qdm/js/common/store/searchHistory.7d9ea.js"], function (require, exports, module) {
    var t = require("lib.Zepto"), o = require("util.ejs2"), e = require("util.Cookie"), n = require("common.login.qidian"), i = require("qidian.report"), r = require("qidian.wxShare"), a = require("qdm/js/common/utils/debounce.5e0cc.js"), c = require("qdm/js/common/components/Toggle.b6163.js");
    require("qdm/js/common/components/Tips.28ade.js"), require("qdm/js/common/components/Loading.f83d8.js");
    var s = require("qdm/js/common/store/searchHistory.7d9ea.js");
    module.exports = {
        init: function () {
            this.initGlobalAjaxSetting(), this.initGlobalAutoLogin(), this.initGlobalLogin(), this.initHeader(), this.initFooter(), this.initWXShare(), i.init({
                path: "msite",
                isQD: !0,
                cname: "QDmlog"
            ...
            var o = this, n = {dataType: "json"}, i = e.get("_csrfToken");
            i && (n.data = {_csrfToken: i}), t.ajaxSettings = t.extend(!0, t.ajaxSettings, n), t(document).on("ajaxError", function (e, n, i) {
                401 === n.status ? o.gotoLogin() : t.isFunction(i.unexpectError) ? i.unexpectError.call(i.context, n, i) : i.noErrorTips || t.tips("网络异常，请稍后重试"), t.unloading(), t(".loading").removeClass("loading")
            }), t.getJSONSlient = function (o, e, n) {
                return t.isFunction(e) && (n = e, e = undefined), t.ajax({
                    type: "get",
                    url: o,
                    data: e,
                    success: n,
                ...
                return i && (o += (o.indexOf("?") > -1 ? "&" : "?") + "_csrfToken=" + i), t.ajax({
                    type: "POST",
                    url: o,
            ...
            n.init(!0), n.setCallback("success", null, function () {
            ...
            t("a.jsLogin").removeClass(".jsLogin").on("click", function (e) {
                e.preventDefault();
                var n = t(this), i = n.prop("href").indexOf("http") > -1 ? n.prop("href") : "";
                o.gotoLogin({returnurl: i})
            })
        }, gotoLogin: function (t) {
            t || (t = {});
            var o = t.returnurl || location.href;
            o.indexOf("?") > -1 ? o += "&from=login" : o += "?from=login", t.returnurl = o, location.href = n.getMLoginUrl(t)
        }, initHeader: function () {
            var o, e = this, n = t(".jsBack").on("click", function (t) {
                /^javas/.test(this.href) && (t.preventDefault(), history.go(-1))
            });
            t("#openSearchPopup").on("click", function (n) {
                n.preventDefault();
                var i = t(this).data("keyword") || "";
                t("#searchPopup").removeAttr("hidden"), t("#keyword").attr("placeholder", i).focus(), o || (o = !0, e.initSearch())
            });
            var i = t("#guideOverlay").on("click", function () {
                t("#openGuide").trigger("click")
            }).attr("role", "button");
            new c("#openGuide", function (t) {
                var o = t.attr("title"), n = t.parents("header");
                /收起/.test(o) ? (t.attr("title", o.replace("收起", "")), n.removeAttr("open"), i.attr("title", "已收起")) : (n.attr("open", ""), t.attr("title", "收起" + o), e.elBacktop && e.elBacktop.trigger("click"), i.attr("title", "点击收起"))
            });
            ...
            r.length && (window.addEventListener("resize", function () {
                ...
                var o = t(this);
                o.parent("h3").attr({role: "navigation", "aria-label": o.hasClass("active") ? "已选择" : ""})
            });
            var a = document.referrer;
            "string" == typeof a && "" === a && n.attr("href", "/")
        }, initFooter: function () {
            var o = t(window), e = t(".jsBackToTop").on("click", function (t) {
                t.preventDefault();
                var e = o.scrollTop(), n = function () {
                    (e *= .5) < 1 ? o.scrollTop(0) : (o.scrollTop(e), requestAnimationFrame(n))
                };
                n()
            });
            this.elBacktop = e;
            ...
            t(".jsDownloadLink").each(function () {
                var o = t(this);
                /^javas/.test(o.attr("href")) && (o.attr("href", i ? o.data("android") : o.data("ios")), o.removeAttr("data-android"), o.removeAttr("data-ios"))
            })
        }, initSearch: function () {
            ...
            var e = t("#keyword"), n = t("#clearSearchKeyword"), i = t("#searchHotHistory"), r = t("#searchList"), c = e.val(), l = function () {
                c && t.getJSON("/majax/search/auto?kw=" + c, function (t) {
                    if (0 === t.code) {
                        if (!c)return;
                        i.attr("hidden", ""), r.removeAttr("hidden").html(o.render("#tpl-search-list.html", t))
                    }
                })
            }, d = a(l, 300);
            e.on("input", function () {
                (c = t(this).val().trim()) ? (n.removeAttr("hidden"), d()) : (n.attr("hidden", ""), i.removeAttr("hidden"), r.attr("hidden", ""))
            }), n.on("click", function () {
                e.val("").trigger("input").focus()
            }), c && (n.removeAttr("hidden"), i.attr("hidden", ""), l()), t("#searchPopup").on("click", ".jsSearchLink", function () {
                c = t(this).data("keyword"), s.addKeyword(c), e.val(c)
            }).on("touchmove", function (t) {
                t.preventDefault()
            }), t("#searchForm").on("submit", function () {
                !(c = e.val().trim()) && e.attr("placeholder") && (c = e.attr("placeholder"), e.val(c)), s.addKeyword(c)
            })
        }, initSearchPopularWords: function () {
            t.getJSON("/majax/search/auto?kw=", function (e) {
                if (0 === e.code) {
                    var n = o.render("#tpl-search-popular-words.html", e), i = t("#searchPopularWords").html(n);
                    t("#keyword").val() ? i.height("auto") : i.unloading(200)
                }
            })
        }, initSearchHistory: function () {
            var e = s.getKeywords(), n = o.render("#tpl-search-history.html", {data: e}), i = t("#searchHistory").html(n);
            t("#clearSearchHistory").on("click", function () {
                s.clearKeywords(), i.attr("hidden", "")
            })
        }, initWXShare: function () {
            var o = document.title, e = location.href, n = t('head [name="description"]').attr("content");
...
define("qdm/js/book/chapter.28e7d.js", ["lib.Zepto", "util.Cookie", "util.ejs2", "qidian.report", "qdm/js/common/page/index.2b38d.js", "qdm/js/common/utils/debounce.5e0cc.js", "qdm/js/common/components/Aside.6dba4.js", "qdm/js/common/components/Panel.77e55.js", "qdm/js/common/components/Range.5d1de.js", "qdm/js/common/components/Toggle.b6163.js", "qdm/js/book/module/Catalog.f7f41.js", "qdm/js/book/module/VoteInteracter.2fc41.js", "qdm/js/book/module/ScrollReader.edb80.js", "qdm/js/book/module/QuickSubscribe.4dd3e.js", "qdm/js/book/module/Subscribe.42c75.js", "qdm/js/book/module/SwipeReader.db4bd.js", "qdm/js/book/component/Verification.64c7f.js", "qdm/js/common/store/recentlyRead.b5fcf.js"], function (require, exports, module) {
    var e = require("lib.Zepto"), t = require("util.Cookie"), a = require("util.ejs2"), o = require("qidian.report"), r = require("qdm/js/common/page/index.2b38d.js"), n = require("qdm/js/common/utils/debounce.5e0cc.js"), i = require("qdm/js/common/components/Aside.6dba4.js"), s = require("qdm/js/common/components/Panel.77e55.js"), c = require("qdm/js/common/components/Range.5d1de.js"), d = require("qdm/js/common/components/Toggle.b6163.js"), p = require("qdm/js/book/module/Catalog.f7f41.js"), h = require("qdm/js/book/module/VoteInteracter.2fc41.js"), l = require("qdm/js/book/module/ScrollReader.edb80.js"), u = require("qdm/js/book/module/QuickSubscribe.4dd3e.js"), f = require("qdm/js/book/module/Subscribe.42c75.js"), g = require("qdm/js/book/module/SwipeReader.db4bd.js"), m = require("qdm/js/book/component/Verification.64c7f.js"), k = require("qdm/js/common/store/recentlyRead.b5fcf.js"), b = e("#pageReadOpt"), v = {
        isLogin: e("body").hasClass("login"),
        settingsKey: b.data("settingsKey"),
        settingsStr: b.data("settingsStr"),
        chapterUrlTpl: g_data.chapterUrlTpl,
        endUrl: g_data.endUrl,
        book: g_data.book,
        chapters: function () {
            var e = {};
            return e[g_data.chapter.chapterId] = g_data.chapter, e
        }(),
    ...
    e(window).on("pageshow", function (e) {
        ...
        init: function () {
            this.initBookStatus(), this.initBookmark(), this.initCopyrightPage(), this.initOptionsLayer(), this.initVoteInteracter(), this.initSubscribe(), this.initOfflineRead(), this.initCatalogAside(), this.initChapterProgress(), this.initFontSizeSetting(), this.initSkinSetting(), this.initModeSetting(), this.initDayNightSetting(), this.initModes(), e("#pageRead").hasClass("H") ? this.swipeReader.enable() : this.scrollReader.enable()
        }, initBookStatus: function () {
            var t = this;
            if (!v.isLogin)return t.initAddToBookshelf(), t.initReadProgress(), void t.initAutoSubscribe();
            e.getJSONSlient("/majax/chapter/GetReadStatus", {
                ...
                0 === e.code && (t.initAddToBookshelf(e.data.isInBookShelf), t.initReadProgress(e.data.readChapterId, e.data.readProgress), t.initAutoSubscribe(e.data.isSubscriber, e.data.autoBuy))
            })
        }, initAddToBookshelf: function (t) {
            function a() {
                v.isInBookShelf = !0, r.remove()
            }

            function o() {
                e.post("/majax/bookshelf/add", {bookId: v.book.bookId}, function (t) {
                    0 === t.code ? (e.tips("加入书架成功"), r.off("click", o), a()) : e.tips("加入书架失败，请稍候再试")
                })
            }
            ...
            var o = this;
            if (t)if (t !== v.chapter.chapterId) {
                var r = !1;
                new s("<h6>检测到你的最新阅读进度为“" + a + "”</h6><p>是否同步到最新？</p>", {
                    buttons: [{}, {
                        value: "同步", events: function () {
                            o.jumpChapter(t), r = !0, e(this).prev().trigger("click")
                        }
                    }], onRemove: function () {
                        r || o.updateReadProgress()
                    }
                })
            } else this.addRecentlyRead(); else o.updateReadProgress()
        }, initAutoSubscribe: function (t, a) {
            var o = e("#swiChk1");
            if (t) {
                var r, n = o.parent(), i = n.data("eids").split("|");
                a ? (o.attr("checked", ""), r = i[0]) : r = i[1], n.data("eid", r), o.on("change", function () {
                    a = o.prop("checked"), o.attr("disabled", ""), e.post("/majax/chapter/saveUserSetting", {
                        bookId: v.book.bookId,
                        autoBuy: a ? 1 : 0
                    }, function (t) {
                        o.removeAttr("disabled"), 0 === t.code ? (a ? (e.tips("开启自动订阅下一章成功"), r = i[0]) : (e.tips("关闭自动订阅下一章成功"), r = i[1]), n.data("eid", r)) : e.tips(t.msg)
                    })
                })
            } else o.parents("a").removeAttr("href"), o.attr("disabled", "")
        }, initBookmark: function () {
            var t = this, a = e("#readBtnTag"), o = a.find("h4");
            t.initBookmarkStatus(), e("#readBtnTag").on("click", function () {
                a.loading(), "del" === a.data("mode") ? (o.html("删除书签中..."), e.post("/majax/chapter/delBookMark", {chapterId: v.chapter.chapterId}, function (o) {
                    a.unloading(), 0 === o.code ? (e.tips("删除书签成功"), t.hideBookmark(), e("#bookmarkX").removeAttr("loaded")) : e.tips("删除书签失败，请稍候再试")
                })) : (o.html("加入书签中..."), e.post("/majax/chapter/addBookMark", {
                    bookId: v.book.bookId,
                    ...
                    a.unloading(), 0 === o.code ? (e.tips("加入书签成功"), t.showBookmark(), e("#bookmarkX").removeAttr("loaded")) : e.tips("加入书签失败，请稍候再试")
                }))
            })
            ...
            var t = e("#readBtnTag"), a = t.find("h4");
            t.data("mode", "del"), a.html("删除书签"), e("#readBookmark").removeAttr("hidden")
        }, hideBookmark: function () {
            var t = e("#readBtnTag"), a = t.find("h4");
            t.data("mode", "add"), a.html("加入书签"), e("#readBookmark").attr("hidden", "")
        }, initCopyrightPage: function () {
            var t = e("#pageRead"), a = e("#readCover"), o = {};
            a.on({
                touchstart: function (e) {
                    o.isH = t.hasClass("H");
                    var r = e.touches[0] || e;
                    o.posX = r.pageX, o.posY = r.pageY, a.addClass("active")
                }, touchmove: function (e) {
                    var t = e.touches[0] || e, r = t.pageX - o.posX, n = t.pageY - o.posY;
                    o.isH ? r < 0 && a.css({
                    ...
                    }), o.distanceX = r, o.distanceY = n, e.preventDefault()
                }, touchend: function () {
                    a.removeClass("active"), o.isH ? o.distanceX < -40 ? (a.css({
            ...
            var t = e("#pageReadOpt"), a = e("#readBtnMore");
            t.on({
                click: function (e) {
                    var a = e.target;
            ...
            function t(r, n) {
                r = r || 0, n = n || 10, e.postJSON("/majax/chapter/getFreeContentMulti", {
                    bookId: a,
                    chapters: o.slice(r, r + n)
                }, function (a) {
                    0 === a.code ? (a.data.chapterList.forEach(function (e) {
                        v.chapters[e.chapterId] = e
                    }), a.data.chapterList.length === n ? t(r + n, n) : (e.unloading(), e.tips("离线成功"))) : (e.unloading(), e.tips(a.msg))
                })
            }

            var a = v.book.bookId, o = [];
            e("#btnDownloadFreeChapters").on("click", function () {
                e.isLoading() || (e.loading(), e("#readBtnMore").trigger("click"), e.getJSON("/majax/chapter/getAllFreeChapterList", {bookId: a}, function (a) {
                    0 === a.code ? ((o = a.data.chapterList).length && (v.lastOfflineChapterId = o[o.length - 1]), t()) : (e.unloading(), e.tips(a.msg))
                }))
            })
        }, initVoteInteracter: function () {
            var t;
            v.book.isSign && e("#btnPledgeTrigger").on("click", function () {
                t ? t.panelToggle(2) : t = new h({bookId: v.book.bookId, bookType: v.book.bookType, showPanel: 2})
            })
            ...
            if (v.book.isVip) {
                ...
                a.on("click", ".jsLoginRss", function () {
                    ...
                    var a = e(this), o = a.parents(".jsChapterWrapper").data("chapter-id"), r = v.chapters[o];
                    r && (r.balance < r.price ? e.tips("您的余额不足，请充值") : (e.loading(), e.postJSON("/majax/subscribe/subscribe", {
                        bookId: v.book.bookId,
                        chapterPrice: r.price,
                        subType: 3,
                        subBalance: r.balance,
                        chapters: [{uuid: r.uuid, chapterId: r.chapterId, chapterCnt: r.wordsCount}],
                        autoSub: a.parents(".jsChapterWrapper").find(".jsAutoRss").hasClass("checked") ? 1 : 0
                    }, function (a) {
                        e.unloading(), 0 === a.code ? e.tips("订阅成功", function () {
                            t.setReadChapter(r.chapterId), setTimeout(function () {
                                location.href = location.href.split("#")[0]
                            }, 0)
                        }) : 1070 === a.code ? t.verification ? t.verification.panel.show() : t.verification = new m({
                            logId: a.data.logId,
                    ...
                    var a = e(this).parents(".jsChapterWrapper").data("chapter-id"), o = v.chapters[a];
                    ...
                    bookId: v.book.bookId, readVipChapterId: function () {
            ...
            function t(t) {
                ...
                e("#asideChapterContent").html(n), o = r.catalog = new p({
            ...
            new i(e("#readBtnChapter"), {
                scrollable: "#catelogX", onInit: function () {
                    if (v.catalog)t({data: v.catalog}); else {
                        var a = this;
                        e.loading(), e.getJSON("/majax/book/category", {bookId: v.book.bookId}, function (o) {
                            e.unloading(), 0 === o.code && (v.catalog = o.data, t(o), e("#asideChapterContent").on("click", ".jsChapter a", function (t) {
                                t.preventDefault(), a.hide(), e("#pageReadOpt").trigger("click"), r.jumpChapter(e(this).data("chapter-id"), !0)
                            }))
                        })
                    }
                }, onShow: function () {
            ...
            function t(t) {
                var a = i.indexOf(t);
                a < 0 && (t = i[a = 0]);
                var o = s[t], r = e("#readProgVal");
                r.find("h4").html(o), r.find("output").html((100 * a / i.length).toFixed(1) + "%")
            }

            function a(a) {
                a.data.vs.forEach(function (e) {
                    e.cs.forEach(function (e) {
                        i.push(e.id), s[e.id] = e.cN
                    })
                }), t(v.chapter.chapterId);
                var n = e("#readProgRange");
                n.attr("max", i.length - 1), n.val(i.indexOf(v.chapter.chapterId)), n.on("change", function () {
                    t(i[this.value])
                }), (o = new c(n, {
                    shadow: !0, buttons: ["#readProgPrev", "#readProgNext"], onChangeEnd: function () {
                        var e = i[n.val()];
                        r.jumpChapter(e, !0)
                    }
                })).shadow()
            ...
            new d(n, {
                callback: function () {
                    o && (o.value(i.indexOf(v.chapter.chapterId)), o.shadow())
                }
            }), n.one("click", function () {
                if (v.catalog)a({data: v.catalog}); else {
                    var t = e("#readOptProg").css("opacity", 0);
                    e.loading(), e.getJSON("/majax/book/category", {bookId: v.book.bookId}, function (o) {
                        e.unloading(), 0 === o.code && (t.css("opacity", 1), v.catalog = o.data, a(o))
                    })
                }
            })
        }, initFontSizeSetting: function () {
            var t = this, a = e("#readBtnSet"), r = e("#readFontRange"), i = e("#chapterContent"), s = r.data("eids").split("|"), p = n(function (e, a) {
                t.scrollReader.refresh(), t.swipeReader.refresh(), o.send(a, {
                    path: "msite",
                    eid: s[e - 1]
                }), t.updateSettings({fs: e})
            }, 300);
            new d(a), new c(r, {buttons: ["#readFontDown", "#readFontUp"]}), r.on("change", function (e) {
                var t = this.value, a = (2 * t + 12) / 16;
                i.css("font-size", a + "rem"), p(t, e)
            })
        }, initSkinSetting: function () {
            var t = this, a = e("body"), o = e("#readBtnMode"), r = n(function (e) {
                t.updateSettings({skin: e})
            }, 300);
            e("#readSetSkin").on("click", '[type="radio"]', function () {
                var t = e(this);
                a.removeClass("read-night"), a.attr("class", a.attr("class").replace(/skin-[a-z]+/g, "skin-" + t.val())), "day" === o.data("mode") && o.trigger("click"), r(t.data("index"))
            })
        }, initModeSetting: function () {
            var t = this, a = n(function (e) {
                t.updateSettings({vh: e})
            }, 300);
            e("#readSetLayout").on("click", '[type="radio"]', function () {
                "v" === this.value ? (e("#pageRead").removeClass("H"), t.scrollReader.enable(), t.swipeReader.disable(), t.jumpChapter(v.chapter.chapterId)) : (e("#pageRead").addClass("H"), t.scrollReader.disable(), t.swipeReader.enable(), t.jumpChapter(v.chapter.chapterId)), a(this.value)
            })
        }, initDayNightSetting: function () {
            var t = this, a = e("body"), o = e("#readBtnMode"), r = o.find("h4"), i = n(function (e) {
                t.updateSettings({dn: e})
            }, 300);
            o.on("click", function () {
                var t = o.data("mode");
                if ("day" === t) {
                    o.data("mode", "night"), r.html(r.html().replace("日", "夜")), a.removeClass("read-night");
                    var n = a.attr("class").match(/skin-([a-z]+)/);
                    n && (n = n[1], e('#readSetSkin [type="radio"][value="' + n + '"]').prop("checked", !0)), i("d")
                } else"night" === t && (o.data("mode", "day"), r.html(r.html().replace("夜", "日")), a.addClass("read-night"), e('#readSetSkin [type="radio"]').each(function () {
                    var t = e(this);
            ...
            var r = this, n = e("#aGotoBookEnd"), i = e("#chapterContent").data("eids").split("|"), s = this.scrollReader = new l({
                ...
                onPrevClick: function (e) {
                    o.send(e, {path: "msite", eid: i[0]})
                },
                onCenterClick: function () {
                    b[0].avoidClick = !0, setTimeout(function () {
                        b[0].avoidClick = !1
                    }, 500), b.addClass("active")
                },
                onNextClick: function (e) {
                    o.send(e, {path: "msite", eid: i[1]})
                },
                onScroll: function (t) {
                    var a;
                    s.$wrapper.find(".jsChapterWrapper").each(function () {
                        if (!a) {
                            var o = e(this), r = o.offset();
                ...
                onScrollPrev: function (t, a) {
                    ...
                    o > 0 ? r.jumpChapter(o, !1, t, a) : (e.tips("已经是第一章了"), a())
                },
                onScrollNext: function (o, i) {
                    var c = v.scrollLastChapter.next;
                    c > 0 ? r.getChapter(c, !1, function (r) {
                        v.scrollLastChapter = r.data.chapterInfo, t(c) ? i() : (e("#chapterContent").append(a.render("#tpl-chapter-content.html", r)), v.scrollLastChapter.next > 0 ? (s.$nextTrigger.show(), n.hide()) : (s.$nextTrigger.hide(), n.show()), o())
            ...
            history.replaceState ? i.getChapter(t, o, function (o) {
                ...
                v.chapter = v.scrollLastChapter = n, n.isFirst ? e("#readCover").removeAttr("hidden") : e("#readCover").attr("hidden", ""), n.next > 0 ? (e("#btnLoadNextChapter").show(), e("#aGotoBookEnd").hide()) : (e("#btnLoadNextChapter").hide(), e("#aGotoBookEnd").show()), e("#chapterTitle").html(n.chapterName), e("#chapterContent").html(a.render("#tpl-chapter-content.html", o)), i.initBookmarkStatus(), i.updateReadProgress(), history.replaceState(null, null, v.chapterUrlTpl.replace("chapterId", t)), e.isFunction(r) ? r() : i.scrollReader.enabled ? i.scrollReader.restart() : i.swipeReader.enabled && i.swipeReader.restart()
            }, n || function () {
            ...
            t.set(v.settingsKey, o, "qidian.com", "/", 31536e6), v.isLogin && e.post("/majax/chapter/saveUserSetting", {settings: o})
        }, updateReadProgress: function () {
            this.addRecentlyRead(), S() || v.isLogin && e.postSlient("/majax/chapter/UpdReadStatus", {
                bookId: v.book.bookId,
                chapterId: v.chapter.chapterId,
                chapterName: v.chapter.chapterName,
                isVip: v.chapter.vipStatus,
            ...
            k.addBook(v.book, v.chapter)
        }, getChapter: function (t, a, o, r) {
            var n = this;
            if (S() && e("#readLoadNext").css("opacity", 1), v.chapters[t])o({
                data: {
                    bookInfo: v.book,
                    chapterInfo: v.chapters[t]
                }
            }); else {
                if (S())return v.chapter.chapterId === v.lastOfflineChapterId && (e("#readLoadNext").css("opacity", 0), e.tips("已显示全部离线章节")), r();
                a && e.loading(), e.getJSON("/majax/chapter/getChapterInfo", {
                    bookId: v.book.bookId,
                    chapterId: t
                }, function (t) {
                    if (a && e.unloading(), 0 === t.code) {
                        var i = t.data.chapterInfo;
                        v.chapters[i.chapterId] = i, t.data.bookInfo && (v.book = t.data.bookInfo), i.vipStatus && i.isBuy && (n.catalog && n.catalog.setChapterSubscribed(i.chapterId), n.subscribe && n.subscribe.setChapterSubscribed(i.chapterId)), o({
                            data: {
                                bookInfo: v.book,
                                chapterInfo: i
                            }
                        })
                    } else a && e.tips("获取章节内容失败，请稍候再试"), r()
                })
            }
        }, setReadChapter: function (t) {
            var a = this, o = v.chapters[t];
            o && o.chapterId !== v.chapter.chapterId && (v.chapter = o, e("#chapterTitle").html(o.chapterName), a.initBookmarkStatus(), a.updateReadProgress(), history.replaceState(null, null, v.chapterUrlTpl.replace("chapterId", t)))
        }
    }
});