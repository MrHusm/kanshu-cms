...
<#include "../common/left.ftl"/>
    ...
    <div class="tpl-content-wrapper">
        <div class="tpl-portlet-components">
            <div class="tpl-block">
                <form action="/channel/add.go" method="post" id="activity_type_list_form" >
                    <table class="am-table  table-main">
                        <tr>
                            <td style="width:15%; text-align:right">渠道ID</td>
                            <td style="width:35%; text-align:left">
                                <input type="text" style="width:80%;"  id="channel" name="channel" value="">
                            </td>
                            <td style="width:15%; text-align:right">渠道名称</td>
                            <td style="width:35%; text-align:left">
                                <input type="text" style="width:80%;"  id="channelName" name="channelName" value="">
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="width:35%; text-align:left">
                                <select name="type" id="type" style="width:80%">
                                    ...
                                    <option value="1">安卓渠道</option>
                                    <option value="2">IOS渠道</option>
                                    <option value="3">H5渠道</option>
                                </select>
                            </td>
                            <td style="width:15%; text-align:right">新增用户数量系数</td>
                            <td style="width:35%; text-align:left">
                                <input type="text" style="width:80%;"  id="dnuRatio" name="dnuRatio" value="">
                            </td>
                        </tr>
                        <tr>
                            <td style="width:15%; text-align:right">日活用户数量系数</td>
                            <td style="width:35%; text-align:left">
                                <input type="text" style="width:80%;"  id="dauRatio" name="dauRatio" value="">
                            </td>
                            <td style="width:15%; text-align:right">收入系数</td>
                            <td style="width:35%; text-align:left">
                                <input type="text" style="width:80%;"  id="moneyRatio" name="moneyRatio" value="">
                            </td>
                        </tr>
                        <tr>
