...
<#include "../common/left.ftl"/>
    ...
    <div class="tpl-content-wrapper">
        <div class="tpl-portlet-components">
            <div class="tpl-block">
                <form action="/searchWordRank/update.go" method="post" id="activity_type_list_form" >
                    <input type="hidden" name="id" value="${searchWordRank.id?c}">
                    <table class="am-table  table-main">
                        <tr>
                            <td style="width:15%; text-align:right">搜索词</td>
                            <td style="width:35%; text-align:left">
                                <input type="text" style="width:80%;"  id="word" name="word" value="${searchWordRank.word}">
                            </td>
                        </tr>
                        <tr>
                            <td style="width:15%; text-align:right">图书IDs</td>
                            <td style="width:35%; text-align:left">
                                <input type="text" style="width:80%;"  id="bookIds" name="bookIds" value="${searchWordRank.bookIds}">
                            </td>
                        </tr>
                        <tr>
